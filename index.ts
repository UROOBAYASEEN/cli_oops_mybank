...
class GET_ACCOUNT{
    ...
    CINC:Number
    selectpincode:number
    INSETAMOUNT:Number
    constructor(fn:string,ln:string,na:string,age:number,soi:string,me:number,nic:number,pincode:number,ins:number){
        this.firstname=fn
        this.lastname=ln
        this.nationality=na
        this.age=age
